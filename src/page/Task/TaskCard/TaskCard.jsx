    ...
    <div>
        <div className='card lg:flex justify-between'>
            <div className='lg:flex gap-5 items-center space-y-2 w-[90%] lg:w-[70%]' >
              ...
              <div className='' >
                <img className='lg:w-[7rem] lg:h-[7rem] object-cover' src='https://wallpapercave.com/wp/wp9027331.jpg' alt=""/>

              </div>
            <div className='space-y-5'>
              <div className='space-y-2'>
               <h1 className='font-bold text-lg'>Car Rental Website</h1> 
               <p className='text-gray-500 text-sm'>Use Latest frameworks and techonolgy to make this Website</p>
              </div>
